...
<?php $__env->startSection('title', 'BicyShop | Edit Discount'); ?>
...
<div class="card">
    ...
    <form action=" <?php echo e(route('discount-edit-submit', $discounts->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row mt-3">
            <div class="p-5 pt-0">
                ...
                <div class="form-group mb-0">
                    ...
                    <input class="form-control <?php $__errorArgs = ['product_id'];
...
unset($__errorArgs, $__bag); ?>" type="text" value="<?php echo e($discounts->Product->product_name); ?>" id="product_id" name="product_id" disabled>
...
unset($__errorArgs, $__bag); ?>" id="product_id" name="product_id" value="" readonly>
                        <option selected disabled><?php echo e($discounts->Product->product_name); ?></option>
...
unset($__errorArgs, $__bag); ?>" type="date" value="<?php echo e($discounts->start); ?>" id="start" name="start">
...
unset($__errorArgs, $__bag); ?>" type="date" value="<?php echo e($discounts->end); ?>" id="end" name="end">
                        <?php $__errorArgs = ['end'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" aria-label="Amount (to the nearest dollar)" min="0" id="percentage" placeholder="Masukkan diskon produk" name="percentage" value="<?php echo e($discounts->percentage); ?>">
