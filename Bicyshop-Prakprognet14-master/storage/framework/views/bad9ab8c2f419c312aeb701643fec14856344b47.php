                                ...
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            ...
                                            <li><a class="btnQuickCart" data-product-nama="<?php echo e($product->product_name); ?>" data-product-id="<?php echo e($product->id); ?>" data-bs-toggle="modal" data-bs-target="#modalCart"><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
                                    <?php
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="under-footer">
                        <p>Copyright © 2022 Bicyshop Co., Ltd. All Rights Reserved.
    ...
    <div class="modal fade" id="modalCart"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <form method="POST" action="<?php echo e(Route('cart.add')); ?>">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="modal-product-nama"></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda ingin memasukkana product ini ke dalam keranjang?</p>
                    <input type="text" name="cart_product_id" id="modal-product-id" value="" hidden>
                </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('body').on('click','.btnQuickCart', function(e){
            e.preventDefault();
            var data = $(this).data();
            $('#modalCart #modal-product-nama').html(data.productNama);
            $('#modalCart #modal-product-id').attr('value', data.productId);
            $('#modalCart').modal();
        });
    });
  </script>
...
</html><?php /**PATH C:\Users\Theny\OneDrive\Documents\kuliah\smt4\Praktikum Prognet\Bicyshop-Prakprognet14-master\resources\views/homepage/index.blade.php ENDPATH**/ ?>