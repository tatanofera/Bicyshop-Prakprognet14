...
<?php $__env->startSection('title', 'BicyShop | Edit Category Product'); ?>
...
<div class="card">
    ...
    <form action=" <?php echo e(route('product-categories-edit-submit', $product_category->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row mt-3">
            <div class="p-5 pt-0">
...
unset($__errorArgs, $__bag); ?>" type="text" value="<?php echo e($product_category->category_name); ?>" placeholder="Masukkan kategori" id="category_name" name="category_name">
