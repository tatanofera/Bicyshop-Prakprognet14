...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input id="telepon" type="text" class="form-control <?php $__errorArgs = ['telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="telepon" value="<?php echo e(old('telepon')); ?>" required autocomplete="telepon" autofocus>
                                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('assets_login_register/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets_login_register/js/popper.js')); ?>"></script>
    <script src="<?php echo e(asset('assets_login_register/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets_login_register/js/main.js')); ?>"></script>

</body>
</html>
<?php /**PATH C:\Users\ASUS\Documents\KULIAH\TUGAS KULIAH\SMT 4\Praktikum Pemrograman Internet\Kelompok\V2\Bicyshop-Prakprognet14-master\resources\views/auth/register.blade.php ENDPATH**/ ?>