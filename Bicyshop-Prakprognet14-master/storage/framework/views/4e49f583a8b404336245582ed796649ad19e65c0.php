    ...
    <div class="card-header">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-end">
                ...
                <a type="button" href="<?php echo e(route('courier-trash')); ?>" class="btn btn-sm btn-info text-white">Trash</a>
            </div>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td>
                        <div>
                            <div class="my-auto">
                                <h6 class="mb-0 text-xs"><?php echo e($loop->index+1+($couriers->currentPage()-1)*5); ?></h6>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td class="align-middle">
                        <form action="<?php echo e(route('courier-delete', $courier->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <a type="button" class="btn btn-primary" href="<?php echo e(route('courier-edit', $courier->id)); ?>">
...
<?php echo $__env->make('admin.layout-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\KULIAH\TUGAS KULIAH\SMT 4\Praktikum Pemrograman Internet\Kelompok\V2\Bicyshop-Prakprognet14-master\resources\views/admin/courier/courier.blade.php ENDPATH**/ ?>