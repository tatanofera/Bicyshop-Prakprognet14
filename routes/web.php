...
Route::get('/checkout', [App\Http\Controllers\User\TransaksiController::class, 'index'])->name('checkout')->middleware('verified');
Route::post('/checkout/confirm', [App\Http\Controllers\User\TransaksiController::class, 'checkout_confirm'])->name('checkout.confirm')->middleware('verified');
