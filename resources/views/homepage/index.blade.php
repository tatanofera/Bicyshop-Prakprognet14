                                ...
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            ...
                                            <li><a class="btnQuickCart" data-product-nama="{{$product->product_name}}" data-product-id="{{$product->id}}" data-bs-toggle="modal" data-bs-target="#modalCart"><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
                                    <?php
